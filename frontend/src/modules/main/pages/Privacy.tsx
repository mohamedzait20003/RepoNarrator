...
const SECTIONS = [
  { title: "1. Who we are", body: `CodeAtlas ("we", "us", "our") is the operator of the CodeAtlas service and the data controller for personal data we collect. Contact: privacy@codeatlas.com.` },
  ...
  { title: "8. Your rights", body: `You may access, correct, or delete your data; restrict processing; and request data portability. Email privacy@codeatlas.com to exercise these rights.` },
...
export default function Privacy() {
  return (
    <div className="flex flex-col">
      ...
      <LegalContentSection
        sections={SECTIONS}
        contactEmail="privacy@codeatlas.com"
